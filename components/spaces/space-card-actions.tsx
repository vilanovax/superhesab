  ...
  return (
    <>
      <button
        ...
        title="آرشیو"
        className="flex size-8 shrink-0 items-center justify-center rounded-full bg-muted/60 text-muted-foreground transition-colors hover:bg-primary/10 hover:text-primary active:scale-95"
        onClick={() => {
          setError(null);
          setConfirmOpen(true);
        }}
